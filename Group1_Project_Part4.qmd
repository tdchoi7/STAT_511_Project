...
lm_thin_1 <- lm(life_exp_2013_response ~ thin_1_19_trnsfrm + thin_5_9_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_thin_1)
anova(lm_thin_1)

lm_thin_2 <- lm(life_exp_2013_response ~ thin_5_9_trnsfrm + thin_1_19_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_thin_2)
anova(lm_thin_2)

# to check if we should drop one of the thinness columns
lm_thin_59 <- lm(life_exp_2013_response ~ thin_5_9_trnsfrm, data = na.omit(life_exp_pt4))


# checking reduced to full model
anova(lm_thin_59, lm_thin_2)

lm_thin_119 <- lm(life_exp_2013_response ~ thin_1_19_trnsfrm, data = na.omit(life_exp_pt4))
...
lm_incsch_1 <- lm(life_exp_2013_response ~ inc_comp + school, data = na.omit(life_exp_pt4))

summary(lm_incsch_1)
anova(lm_incsch_1)

lm_incsch_2 <- lm(life_exp_2013_response ~ school + inc_comp, data = na.omit(life_exp_pt4))

summary(lm_incsch_2)
anova(lm_incsch_2)

# to check if we should drop school or inc_comp
lm_inc <- lm(life_exp_2013_response ~ inc_comp, data = na.omit(life_exp_pt4))

anova(lm_inc, lm_incsch_1)

lm_school <- lm(life_exp_2013_response ~ school, data = na.omit(life_exp_pt4))
...
lm_percgdp_1 <- lm(life_exp_2013_response ~ perc_exp_trnsfrm + gdp_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_percgdp_1)
anova(lm_percgdp_1)

lm_percgdp_2 <- lm(life_exp_2013_response ~ gdp_trnsfrm +  perc_exp_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_percgdp_2)
anova(lm_percgdp_2)

# check which column to drop
lm_percexp <- lm(life_exp_2013_response ~ perc_exp_trnsfrm, data = na.omit(life_exp_pt4))

anova(lm_percexp, lm_percgdp_1)

lm_gdp <- lm(life_exp_2013_response ~ gdp_trnsfrm, data = na.omit(life_exp_pt4))
...
lm_ifu5_1 <- lm(life_exp_2013_response ~ inf_death_trnsfrm + u5_deaths_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_ifu5_1)
anova(lm_ifu5_1)

lm_ifu5_2 <- lm(life_exp_2013_response ~ u5_deaths_trnsfrm + inf_death_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_ifu5_2)
anova(lm_ifu5_2)

# check which column to drop
lm_inf <- lm(life_exp_2013_response ~ inf_death_trnsfrm, data = na.omit(life_exp_pt4))

anova(lm_inf, lm_ifu5_1)

lm_u5 <- lm(life_exp_2013_response ~ u5_deaths_trnsfrm, data = na.omit(life_exp_pt4))
...
lm_hepbdipth_1 <- lm(life_exp_2013_response ~ hep_b_trnsfrm + dipth_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_hepbdipth_1)
anova(lm_hepbdipth_1)

lm_hepbdipth_2 <- lm(life_exp_2013_response ~ dipth_trnsfrm + hep_b_trnsfrm, data = na.omit(life_exp_pt4))

summary(lm_hepbdipth_2)
anova(lm_hepbdipth_2)

# check which column to drop
lm_hepb <- lm(life_exp_2013_response ~ hep_b_trnsfrm, data = na.omit(life_exp_pt4))

anova(lm_hepb, lm_hepbdipth_1)

lm_dipth <- lm(life_exp_2013_response ~ dipth_trnsfrm, data = na.omit(life_exp_pt4))

anova(lm_dipth, lm_hepbdipth_2)

```

> thin_1_19_trnsfrm and perc_exp can be dropped from the model as they have high p-values. We will drop thinness only for now as there should be a direct overlap between thin_1_19_trnsfrm and thin_5_9_trnsfrm
...
# life_exp_pt4 <- life_exp_pt4[-3]

# fitting the full model
# FullModel <- lm(life_exp_2013_response ~ ., data = life_exp_pt4[,-6])
...
Base <- lm(life_exp_2013_response ~ 1, data = na.omit(life_exp_pt4))
FullModel <- lm(life_exp_2013_response ~ ., data = na.omit(life_exp_pt4))
...
adult_mort_red <- lm(life_exp_2013_response ~ adult_mort + alcohol_trnsfrm, data = na.omit(life_exp_pt4))

adult_mort_int <- lm(life_exp_2013_response ~ adult_mort * alcohol_trnsfrm, data = na.omit(life_exp_pt4))
...
inf_death_trnsfrm_red <- lm(life_exp_2013_response ~ inf_death_trnsfrm + continent, data = na.omit(life_exp_pt4))

inf_death_trnsfrm_int <- lm(life_exp_2013_response ~ inf_death_trnsfrm * continent, data = na.omit(life_exp_pt4))
...
aids_death_trnsfrm_red <- lm(life_exp_2013_response ~ aids_trnsfrm + continent, data = na.omit(life_exp_pt4))

aids_death_trnsfrm_int <- lm(life_exp_2013_response ~ aids_trnsfrm * continent, data = na.omit(life_exp_pt4))
...
m2 <- lm(formula = life_exp_2013_response ~ inc_comp + aids_trnsfrm +
    tot_exp_trnsfrm + perc_exp_trnsfrm + gdp_trnsfrm + adult_mort * alcohol_trnsfrm,
    data = na.omit(life_exp_pt4))
...
> $\hat{y_i}$ = 50.3840 + 32.9851 x inc_comp + -6.4658 x aids_trnsfrm + 1.2166 x tot_exp_trnsfrm + -1.2248 x adult_mort + 1.4622 x perc_exp_trnsfrm + -0.7980 x gdp_trnsfrm
...
> According to our regression models, inc_comp + aids_trnsfrm + tot_exp_trnsfrm + adult_mort + perc_exp_trnsfrm + gdp_trnsfrm are the variables that are most asscociated with out outcome of interest. It makes sense that adult mortality will affect life expectancy. It seems that more education and wealth can afford healthier lifestyles and mortal diseases such as aids will definitely have a negative impact on longevity. The predictor variables explain 87.05% of the variation in Y according to the adjusted $R^2$
