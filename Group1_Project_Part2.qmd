...
> Instead of using countries, we will use continents. The code for that has been provided in lines 55-57
...
write.csv(life_exp1,filepath)

# Data that was first imported was edited after data cleaning 
#
#
#
#
